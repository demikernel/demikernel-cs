...
public class Demikernel<T>
{
    ...
    private Action<T, Demikernel.Interop.Socket, AcceptResult> OnAccept;
    ...
    public unsafe Demikernel(
        Action<T, Demikernel.Interop.Socket, AcceptResult> OnAccept,
    ...
    private unsafe void Execute()
    {
        ...
        try
        {
            ...
            while (true)
            {
                ...
                {
                    case Opcode.Accept:
                        this.OnAccept(state, qr.AcceptResult.Socket, qr.AcceptResult);
                        break;
                    case Opcode.Connect:
